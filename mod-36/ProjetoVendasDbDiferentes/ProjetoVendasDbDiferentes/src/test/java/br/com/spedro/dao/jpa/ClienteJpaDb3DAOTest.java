...
public class ClienteJpaDb3DAOTest {

    private IClienteJpaDAO<ClienteJpa> clienteDao;

    private IClienteJpaDAO<ClienteJpa> clienteDb2Dao;

    private IClienteJpaDAO<ClienteJpa> clienteDb3Dao;

    private Random rd;

    public ClienteJpaDb3DAOTest() {
    ...
    public void end() throws DAOException {
        ...
        Collection<ClienteJpa> listDb3 = clienteDb3Dao.buscarTodos();
        listDb3.forEach(cli -> {
            try {
    ...
    public void pesquisarCliente() throws TipoChaveNaoEncontradaException, DAOException, MaisDeUmRegistroException, TableException {
        ...
        //DB 3
        cliente.setId(null);
        clienteDb3Dao.cadastrar(cliente);
        ClienteJpa clienteConsultado3 = clienteDb3Dao.consultar(cliente.getId());
    ...
    public void salvarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        //DB 3
        cliente.setId(null);
        ClienteJpa retorno3 = clienteDb3Dao.cadastrar(cliente);
        Assert.assertNotNull(retorno3);
        ClienteJpa clienteConsultadoDb3 = clienteDb3Dao.consultar(retorno3.getId());
        Assert.assertNotNull(clienteConsultadoDb3);
    }
    ...
    public void alterarCliente() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {//DB 1
        ...
        ClienteJpa retorno3 = clienteDb3Dao.cadastrar(cliente);
        Assert.assertNotNull(retorno3);
        clienteConsultado = clienteDb3Dao.consultar(cliente.getId());
        Assert.assertNotNull(clienteConsultado);
        clienteConsultado.setNome("Pedro Henrique");
        clienteDb3Dao.alterar(clienteConsultado);
        clienteAlterado = clienteDb3Dao.consultar(clienteConsultado.getId());
        Assert.assertNotNull(clienteAlterado);
        Assert.assertEquals("Pedro Henrique", clienteAlterado.getNome());
    }
    ...
    public void buscarTodos() throws TipoChaveNaoEncontradaException, DAOException {
        ...
        cliente1.setId(null);
        //DB 2
        retorno = clienteDb3Dao.cadastrar(cliente);
        Assert.assertNotNull(retorno);

        retorno1 = clienteDb3Dao.cadastrar(cliente1);
        Assert.assertNotNull(retorno1);
