...
public class VendaJpaDb2DAOTest {

    private IVendaJpaDAO<VendaJpa> vendaDao;

    private IVendaJpaDAO<VendaJpa> vendaExclusaoDao;
    ...
    public VendaJpaDb2DAOTest() {
        this.vendaDao = new VendaJpaDb2DAO();
        vendaExclusaoDao = new VendaExclusaoJpaDAO("Postgre2");
        this.clienteDao = new ClienteJpaDb2DAO();
        this.produtoDao = new ProdutoJpaDb2DAO();
        rd = new Random();
    }
    ...
    public void adicionarMaisProdutosDoMesmo() throws TipoChaveNaoEncontradaException, MaisDeUmRegistroException, TableException, DAOException {
        ...
        VendaJpa vendaConsultada = vendaDao.consultarComCriteria(venda.getId());
