...
public class VendaJpaDb3DAOTest {
    ...
    public VendaJpaDb3DAOTest() {
        this.vendaDao = new VendaJpaDb3DAO();
        vendaExclusaoDao = new VendaExclusaoJpaDAO("Mysql1");
        this.clienteDao = new ClienteJpaDb3DAO();
        this.produtoDao = new ProdutoJpaDb3DAO();
        rd = new Random();
    }
